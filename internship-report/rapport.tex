...
\section{Schémas composables dans des catégories simples}
...
\subsection{Contextes} Les contextes sont des couples $(\Theta, \Gamma)$. $\Gamma$ prend la forme d'une liste de flèches définies inductivement par : $$ \Gamma ::= \epsilon \ \text{(contexte vide)} \ |\ \Gamma , f : x \rightarrow y$$
...
\section{Schémas composables dans des catégories cartésiennes}
...
\subsection{Termes} Pour $\Gamma$ un contexte et $A$ une flèche nous enrichissons la définition de $Tm(\Gamma, A)$ : nous ajoutons pour chaque type une flèche terminale, des flèches universelles pour les produits et des projections sur respectivement la première et la seconde composante.
\begin{center}
	\begin{prooftree}
...
\bibitem{b1} \href{https://www.lix.polytechnique.fr/Labo/Samuel.Mimram/docs/mimram_cccatt.pdf}{Samuel Mimram, ``An unbiased simply typed combinatory logic,'' LIX, CNRS, École polytechnique, Institut Polytechnique de Paris, Palaiseau, France, 2026}
