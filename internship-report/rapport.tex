...
\begin{document}
	...
	On introduit un système d'inférence logique composé de 2 règles engendrant les termes normalisés. Ces règles doivent apparaître comme des intermédiaires entre le système très souple qui définit les termes, et le système de réécriture linéaire qui définira les schémas composables.
	\begin{center}
		\begin{prooftree}
	...
	Par le théorème précédent, nous avons obtenu l'unicité sous réserve d'existence. Nous montrons que chaque schéma composable est habité par un terme. Pour cela, nous construisons inductivement un terme en déconstruisant l'arbre de dérivation du schéma composable. Formellement, pour tout context $\Gamma$, toute flèche $A$ tel que $\Gamma \vdash_{ps} A$ est dérivable, il existe un morphisme $f$ tel que $\Gamma \vdash f : A$ est dérivable.
	...
	Les règles que nous proposons pour la construction de schémas composables dans le cas cartésiens apparaissent comme moins élégantes dues à leur démultiplication.
	\begin{center}
		\begin{prooftree}
