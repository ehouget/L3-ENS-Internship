...
\begin{document}
	...
	Nous n'avons pas formaliser en agda 
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\end{align*}
		\end{itemize}
		\item $f : x \rightarrow y, g : x \rightarrow z \vdash \left<f, g\right> \cdot fst = f$
		\item $f : x \rightarrow y, g : x \rightarrow z \vdash \left<f, g\right> \cdot snd = g$
